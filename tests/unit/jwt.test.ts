...
describe('JWT Utilities', () => {
  describe('parseTokenExpiryToMs', () => {
    ...
    it('should throw error for invalid format', () => {
      expect(() => parseTokenExpiryToMs('invalid')).toThrow('Invalid token expiry format')
      expect(() => parseTokenExpiryToMs('30')).toThrow('Invalid token expiry format')
      expect(() => parseTokenExpiryToMs('30x')).toThrow('Invalid token expiry format')
    })
  })
